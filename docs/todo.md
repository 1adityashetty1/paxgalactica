...
- **Art for the three non-outcomes** — item 17. The engine already types
  `refusal`, `defiance` and `negotiation`, so this is asset plus renderer, no
  schema work.
...
## 17. OPEN — art for the three ways an action does not simply happen
