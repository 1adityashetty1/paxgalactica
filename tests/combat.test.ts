      ...
      it('kills a named officer only on a high roll, and only where they stand', () => {
        const knife = (systemId: string, atSystemId: string | null) => {
          ...
          s.agents.push({
            ...
            name: '', operations: 0, timesCaught: 0, discordMoved: 0,
          });
          let st = s;
          const seen: string[] = [];
          for (let i = 0; i < 20; i++) {
    ...
    describe('and the people around them', () => {
      ...
      it('keeps officers and operatives out of each other’s names', () => {
        ...
        s.agents.push({
          ...
          name: 'Voss Greywake', operations: 0, timesCaught: 0, discordMoved: 0,
        });
      ...
      it('names an operative, and takes them alive when the line is closed', () => {
        ...
        s.agents.push({
          ...
          targetCommanderId: null,
          name: 'Prynn Threxwind', operations: 0, timesCaught: 0, discordMoved: 0,
        });
        let st = s;
      ...
      it('questions an operative into paper too', () => {
        ...
        s.agents.push({
          ...
          targetCommanderId: null,
          name: 'Aleska Halfshare', operations: 0, timesCaught: 0, discordMoved: 0,
        });
        s.assets.push({
