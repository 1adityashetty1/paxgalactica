...
interface SeedFaction {
  ...
  stats: FactionStats;
  voice: string;
  /** What this power's leader is called. Reaches the player through the advisor. */
  title: string;
  warEthic: WarEthic;
